    ...
    <div class="performancePage">
        <div class="pageS1">
            ...
            @component('new-theme.settings.performance-s.components.tabs')
                ...
                <div class="tab-pane fade show active" id="pills-performanceFactors" role="tabpanel"
                    aria-labelledby="pills-performanceFactors-tab">
                    <div class='sectionS2'>
                        <div class="head withBorder flex align between">
                            <h3 class='small'>@lang('Performance Factors')</h3>
                            <div class="flex align gap-3">

                                @can('PerformanceFactor-Create')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class='action flex gap-3'>
                                                    ...
                                                    @can('PerformanceFactor-Delete')
                                                        <div data-bs-toggle="modal"
                                                            data-bs-target="#delete-{{ $performancefactor->id }}">
                    ...
                    <div class="paginater paginationS1 flex gap-4 align">
                        @include('new-theme.settings.performance-s.components.paginate')
                    </div>
            ...
            @include('new-theme.settings.performance-s.components.add')
        </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            function fetch_data() {
                $.ajax({
                    url: "{{ route('PerformanceFactor.index') }}",
                    data: {
                        "search": $('#search').val()
                    },
