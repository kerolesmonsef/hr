        ...
        <div class="pageS1">
            ...
            <div class='sectionS2'>
                <div class="head withBorder flex align between">
                    <h3 class='small'> @lang("Assets Types")</h3>

                    @can('AssetTypes-Create')
                ...
                <div class="search">
                    <div class="inputS1 searchInput">
                        <input type="text" placeholder="@lang("Search")...." id="search">
                ...
                <div class="tableS1 scroll">
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.settings.assets-types.assets-types')
                        </tbody>
                    </table>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form class="formS1" method="post" action="{{ route('assets-types.store') }}">
                                @csrf
                                <div class="sectionS2">
                                    <div class="head withBorder flex align between">
                                        <h3 class='small'>@lang('Add Assets Type')</h3>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="content">
                                        <div class="">
                                            <label for="payrollType" class="form-label">@lang('Assets Type')</label>
                                            <div class="inputS1">
                                                <input type="text" name="name" placeholder='@lang('Enter Assets Type')'
                                                    required>
                                            </div>
                                        </div>
