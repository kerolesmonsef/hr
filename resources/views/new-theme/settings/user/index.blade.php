    ...
    <div class="pageS1">
        <div class='sectionS2'>
            <div class="head withBorder flex align between">
                <h3 class='small'>{{__("Users")}}</h3>

                @can('Users-Create')
                    <a href="{{Route('user.create')}}">
                        <button class='buttonS1 primary'>
                            <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.580872 7C0.580872 6.68934 0.869747 6.4375 1.22609 6.4375H15.4209C15.7773 6.4375 16.0662 6.68934 16.0662 7C16.0662 7.31066 15.7773 7.5625 15.4209 7.5625H1.22609C0.869747 7.5625 0.580872 7.31066 0.580872 7Z" fill="white" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.32352 0.25C8.67986 0.25 8.96874 0.50184 8.96874 0.8125V13.1875C8.96874 13.4982 8.67986 13.75 8.32352 13.75C7.96717 13.75 7.6783 13.4982 7.6783 13.1875V0.8125C7.6783 0.50184 7.96717 0.25 8.32352 0.25Z" fill="white" />
                            </svg>
                            {{__("Add New")}}
                        </button>
                    </a>
            ...
            <div class="tableS1 scroll">
                <table>
                    ...
                    <tbody>
                        @include('new-theme.settings.user.users')
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="paginationS1 paginater flex gap-4 align">
            @include('new-theme.settings.user.paginate')
        </div>
