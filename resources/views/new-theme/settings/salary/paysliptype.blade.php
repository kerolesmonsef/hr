    ...
    <div class="branchesPage">
        <div class="pageS1">
            @component('new-theme.settings.salary.components.tabs')
                @slot('active', 'paysliptype')
                <div class="tab-pane fade show active">
                    <div class='sectionS2'>
                        <div class="head withBorder flex align between">
                            <h3 class="small">{{__("Manage Payslip Type")}}</h3>

                            @can('PayslipType-Create')
                                <button class='buttonS1 primary' data-bs-toggle="modal" data-bs-target="#addNewPaySlip">
                        ...
                        <div class="tableS1 scroll">
                            <table>
                                <thead>
                                    <tr>
                                        <th>@lang('Payslip Number')</th>
                                        <th>@lang('Payslip Type')</th>
                                        <th>@lang('Action')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @include("new-theme.settings.salary.paginations.paysliptype_pagination")
                                </tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="formS1" method="post" action="{{ route('paysliptype.store') }}">
                        ...
                        <div class="sectionS2">
                            <div class="head withBorder flex align between">
                                <h3 class='small'>{{__('Add New payslip type')}}</h3>
                            ...
                            <div class="content">
                                <div class="">
                                    ...
                                    <div class="inputS1">
                                        <input name="name_ar" value="{{ old('name_ar') }}" type="text" id="paySlipType"
                                            placeholder='@lang('Enter Payslip Type Arabic')'>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="inputS1">
                                        <input name="name" value="{{ old('name') }}" type="text" id="paySlipTypeEn"
                                            placeholder='@lang('Enter Payslip Type English')'>
                                    </div>
                                </div>
