...
@section('content')
    <div class="salaryPage">
        <div class="pageS1">
            @component("new-theme.settings.salary.components.tabs")
                @slot("active","loanoption")
                <div class="tab-pane fade show active">
                    <div class='sectionS2'>
                        <div class="head withBorder flex align between">
                            <h3 class="small">{{__("Manage Loan Option")}}</h3>
                            @can('LoanOption-Create')
                                <button class='buttonS1 primary' data-bs-toggle="modal" data-bs-target="#addNewLoanOption">
                        ...
                        <div class="tableS1 scroll">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th>@lang("Loan Option")</th>
                                    <th>@lang("Action")</th>
                                </tr>
                                </thead>
                                <tbody>
                                @include("new-theme.settings.salary.paginations.loanoption_pagination")
                                </tbody>
                            </table>
                        </div>
                    </div>
    ...
    <!-- Add New Loan Modal -->
    <div class="modal fade customeModal" id="addNewLoanOption" tabindex="-1" aria-labelledby="addNewLoanOptionLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="formS1" method="post" action="{{ route("loanoption.store") }}">
                        @csrf
                        <div class="sectionS2">
                            <div class="head withBorder flex align between">
                                <h3 class='small'>@lang("Add New loan option")</h3>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div class="content">
                                <div class="">
                                    <label for="loanOption" class="form-label">@lang("Loan Option Arabic")</label>
                                    <div class="inputS1">
                                        <input name="name_ar" value="{{ old("name_ar") }}" type="text" id="loanOption"
                                               placeholder='@lang("Enter Loan Option Arabic")'>
                                    </div>
                                </div>

                                <div class="">
                                    <label for="loanOptionEn" class="form-label">@lang("Loan Option English")</label>
                                    <div class="inputS1">
                                        <input name="name" value="{{ old("name") }}" type="text" id="loanOptionEn"
                                               placeholder='@lang("Enter Loan Option English")'>
                                    </div>
                                </div>
