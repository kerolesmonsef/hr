...
@section('content')
    <div class="branchesPage">
        <div class="pageS1">
            @component("new-theme.settings.salary.components.tabs")
                @slot("active","paymenttype")
                <div class="tab-pane fade show active" >
                    <div class='sectionS2'>
                        <div class="head withBorder flex align between">
                            <h3 class="small">{{__('Manage Payment Type')}}</h3>
                            @can('PaymentType-Create')
                                <button class='buttonS1 primary' data-bs-toggle="modal" data-bs-target="#addNewPaymentType">
                        ...
                        <div class="tableS1 scroll">
                            <table>
                                ...
                                <tbody>
                                @include("new-theme.settings.salary.paginations.paymenttype_pagination")
                                </tbody>
                            </table>
                        </div>
                    </div>
    ...
    <div class="modal fade customeModal" id="addNewPaymentType" tabindex="-1" aria-labelledby="addNewPaymentTypeLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="formS1" method="post" action="{{ route("paymenttype.store") }}">
                        @csrf
                        <div class="sectionS2">
                            <div class="head withBorder flex align between">
                            ...
                            <div class="content">
                                ...
                                <div class="">
                                    <label for="paymentTypeEn" class="form-label">@lang("Payment Type")</label>
                                    <div class="inputS1">
                                        <input name="name" value="{{ old("name") }}" type="text" id="paymentTypeEn" placeholder='@lang("Enter Payment Type")'>
                                    </div>
                                </div>
