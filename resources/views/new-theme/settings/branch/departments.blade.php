...
@section('content')
    <div class="branchesPage">
        <div class="pageS1">
                    ...
                    <div class='sectionS2'>
                        <div class="head withBorder flex align between">
                            ...
                            @can('Department-Create')
                                <button class='buttonS1 primary' data-bs-toggle="modal" data-bs-target="#addNewDepartment">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('Department Manger')</th>
                                        <th>@lang('Employees Number') </th>
                                        <th>@lang('Action')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                   @include("new-theme.settings.branch.departments_table")
                                </tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div class="modal fade customeModal" id="addNewDepartment" tabindex="-1"
                aria-labelledby="addNewDepartmentLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form class="formS1" method="post" action="{{ route('department.store') }}">
                                @csrf
                                @method('post')
                                <div class="sectionS2">
                                    <div class="head withBorder flex align between">
                                    ...
                                    <div class="content">
                                        <div class="">
                                            ...
                                            <div class="inputS1">
                                                <input {{ old('name') }} name="name" type="text"
                                                    id="departmentName-en" placeholder='@lang('Enter Department Name English')'>
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="inputS1">
                                                <input {{ old('name_ar') }} name="name_ar" type="text"
                                                    id="departmentName-ar" placeholder='@lang('Enter Department Name Arabic')'>
                                            </div>
                                        </div>

                                        <div class="">
                                            <label for="branch-edit-ds" class="form-label">@lang('Branch')</label>
                                            <div class="inputS1">
                                                <select name="branch_id" id="branch-edit-ds">
                                                    @foreach ($branches as $branch)
                                                        <option
                                                            {{ old('branch_id', $branch->id) == old('branch_id') ? 'selected' : '' }}
                                        ...
                                        <div class="">
                                            <label for="employee-Ar" class="form-label">@lang('Department Manager')</label>
                                            <div class="inputS1">
                                                <select name="employee_id" id="employee-Ar">
