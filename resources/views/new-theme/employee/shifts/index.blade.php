        ...
        <div class="pageS1">
            <div class='sectionS2'>
                <div class="head withBorder flex align between">
                    <h3 class='small'>{{ __('All Shifts') }}</h3>
                    <div class='flex align gap-3 options'>

                        @can('Shift-Print')
                            <a href="{{ route('employee-shifts.print') }}" target="_blank" class='buttonS2  withBorder'>
                        ...
                        @can('Shift-Export')
                           <a href="{{ route('employee-shifts.export') }}" class='buttonS2 withBorder'>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="tableS1 scroll trPointer">
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.employee.shifts.shifts')
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="paginater">
                @include('new-theme.employee.shifts.paginate')
            </div>
        </div>
    </div>
@endsection
