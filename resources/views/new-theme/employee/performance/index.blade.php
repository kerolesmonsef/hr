...
@section('content')
    <div class="evaluationPage">
        <div class="pageS1">
            @component('new-theme.employee.evaluations.tabs')
                @slot('active', 'performance')

                <div class="tab-pane show active" id="performance" role="tabpanel" aria-labelledby="performance-tab">
                    <div class='sectionS2'>
                        <div class="head withBorder flex align between options">
                            <h3 class='small'>{{ __('Performance') }}</h3>
                        ...
                        <div class="searchWithDate options">
                            ...
                            <div class='datePickerContainer'>
                                <div class='datePicker'>
                                    ...
                                    <div class="inputS1 noHeight">
                                        ...
                                        <input style="width: 225px;" type="text" id="start_date" value=""
                                               placeholder="{{ __('Start date') }}" name="daterange"
                                ...
                                <div class='datePicker '>
                                    ...
                                    <div class="inputS1 noHeight">
                                        <img src="/new-theme/icons/date.svg" class="iconImg"/>
                                        <input style="width: 225px;" type="text" id="end_date" value=""
                                               placeholder="{{ __('End date') }}" name="daterange"
                                               class="datePickerCustom"
                                               autocomplete="off"/>
                                    </div>
                                </div>
                        ...
                        <div class="tableS1 scroll trPointer">
                            <table>
                                ...
                                <tbody>
                                @include('new-theme.employee.performance.performance')
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="paginater">
                        @include('new-theme.employee.performance.paginate')
                    </div>
                </div>
            @endcomponent
        </div>
...
@push('script')
    @include("new-theme.components.export_print",[
        "export_url"=>route('performance.export'),
        'print_url'=>route('performance.print')
    ])
