        ...
        <div class="pageS1">
            ...
            <div class='sectionS2'>
                <div class="head withBorder flex align between options">
                    <h3 class='small'>{{ __('All Loans') }}</h3>
                        ...
                        <div class='datePicker'>
                            ...
                            <div class="inputS1 noHeight">
                                ...
                                <input style="width: 225px;" id="start_date" type="text" value=""
                                    placeholder="{{ __('Start date') }}" name="datepicker" class="datePickerCustom"
                                    autocomplete="off" />
                            </div>
                        </div>
                        <div class='datePicker '>
                            ...
                            <div class="inputS1 noHeight">
                                ...
                                <input style="width: 225px;" id="end_date" type="text" value=""
                                    placeholder="{{ __('End date') }}" name="datepicker" class="datePickerCustom"
                                    autocomplete="off" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="tableS1 scroll trPointer">
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.employee.loan.loan')
                        </tbody>
                    </table>
                </div>
            </div>
            <div class="paginater">
                @include('new-theme.employee.loan.paginate')
            </div>


            <!-- rejected modal -->
            <div class="modal fade customeModal" id="rejectReason" tabindex="-1"
...
@push('script')
    ...
    @include("new-theme.components.export_print",[
        'export_url'=> route('loan-requests.export'),
        'print_url'=> route('loan-requests.print'),
    ])
    <script>
