        ...
        <div class="pageS1">
            <div class='sectionS2'>
                <div class="head withBorder flex align between options">
                    <h3 class='small'>{{ __('All Vacations') }}</h3>
                    <div class='flex align gap-3 options'>
                        
                        @can('Vacation-Print')
                            <button class='buttonS2  withBorder' id="print">
                ...
                <div class="tableS1 scroll trPointer">
                    <table class="table-responsive">
                        ...
                        <tbody>
                            @include('new-theme.employee.vacations.vacations')
                        </tbody>
                    </table>
                    <!-- disabled -->
            ...
            <div class="paginater flex gap-4 align">
                @include('new-theme.employee.vacations.paginate')
            </div>
        </div>
    </div>
@endsection
@push('script')
    @include('new-theme.components.export_print', [
        'print_url' => route('vacations.print'),
        'export_url' => route('vacations.export'),
    ])
    <script>
