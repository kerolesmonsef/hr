                    ...
                    <div class='sectionS2'>
                                ...
                                <div class='datePicker '>
                                    ...
                                    <div class="inputS1 noHeight">
                                        ...
                                        <input id="end_date" style="width: 225px;" type="text" value=""
                                               placeholder="{{__("End Date")}}" name="daterange" class="datePickerBasic"
                                               autocomplete="off"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tableS1 scroll trPointer">
                            <table>
                                ...
                                <tbody>
                                @include('new-theme.employee.evaluations.evaluations')
                                </tbody>
                            </table>
                        </div>
                    </div>
                    <div class="paginater paginationS1 flex gap-4 align">
                        @include("new-theme.employee.evaluations.paginate")
                    </div>
                </div>
            @endcomponent
...
@push('script')
    @include('new-theme.components.export_print',[
        'print_url'=> route("evaluation.print"),
        'export_url'=> route("evaluation.export"),
    ])
