        ...
        <div class="pageS1">
            <div class='sectionS2'>
                <div class="head withBorder flex align between">
                    <h3 class='small'>{{ __('Over Time') }}</h3>
                ...
                <div class="searchWithDate ">
                    <div class="inputS1 primary searchInput">
                        <input type="text" placeholder="{{ __('Search') }}" value="{{ request('search') }}"
                            id="search">
                    ...
                    <div class='datePickerContainer'>
                        <div class='datePicker'>
                            ...
                            <div class="inputS1">
                                ...
                                <input id="start_date" style="width: 225px;" type="text" value="" placeholder="{{__('Start date')}}"
                        ...
                        <div class='datePicker'>
                            ...
                            <div class="inputS1">
                                <img src="/new-theme/icons/date.svg" class="iconImg" />
                                <input id="end_date" style="width: 225px;" type="text" value="" placeholder="{{__('End date')}}"
                                    name="datepicker" class="datePickerBasic" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="tableS1 scroll trPointer">
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.requests.overtime.overtime')
                        </tbody>
                    </table>

                    <!-- disabled -->
                    <!-- <button class="buttonS2 primary disabled">Accept</button> -->

                </div>
            </div>

            <div class="paginater paginationS1 flex gap-4 align">
                @include('new-theme.requests.overtime.paginate')
            </div>
                        ...
                        <div class="modal-body">
                            <form class="formS1 reject-form" action="" method="post">
                                ...
                                <div class="sectionS2">
                                    ...
                                    <div class="content">
                                        <div class="">
                                            <label for="ID" class="form-label">{{ __('Reason') }}</label>
                                            <div class="inputS1">
                                                <input required type="text" name="admin_message"
...
@push('script')
    ...
    @include("new-theme.components.export_print",[
        'export_url'=> route('over-time.export'), 
        'print_url'=> route('over-time.print'), 
    ])
    <script>
